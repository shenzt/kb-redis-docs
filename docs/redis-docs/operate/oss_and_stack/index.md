...
For occasional updates on the new Redis releases, you can [check out the What’s New section](https://redis.io/docs/latest/develop/whats-new/).
...
Redis regularly sponsors conferences, webinars, and meetups. Check out the [Redis events](https://redis.io/events/) page for details.
