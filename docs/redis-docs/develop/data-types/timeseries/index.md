...
{{< clients-example set="time_series_tutorial" step="create_retention" description="Data retention: Use TS.ADD with RETENTION option to automatically expire old data points based on time since the last update" difficulty="intermediate" buildsUpon="create" >}}
